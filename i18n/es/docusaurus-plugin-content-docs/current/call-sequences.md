...
Diagramas de secuencia Mermaid detallados para cada flujo principal en **llm.Port**.
...
## 2. Chat Completions (Sin Streaming)
...
## 5. Topología LLM & Trazas en Vivo
