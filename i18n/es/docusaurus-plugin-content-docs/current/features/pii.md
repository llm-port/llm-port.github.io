...
La detección de PII se ejecuta como un servicio FastAPI independiente al que el gateway llama durante el procesamiento de solicitudes. Cuando está habilitado, las solicitudes salientes pueden escanearse en busca de información de identificación personal antes de que lleguen a los proveedores upstream.
